...
import BottomSheet from "@/src/app/component/BottomSheetSelect";
...
export default function Home() {
  ...
  return (
      <div
        ...
        }} className="border text-t-primary p-6 rounded-[12px]">
          open
        </button>
        <button onClick={() => {
          router.push('/mile')
          ...
          <div className="flex flex-col gap-6  pt-6">
            ...
            <div className="p-4 bg-bg-state rounded-[12px] text-t-primary">
              <ul className="flex flex-col gap-1 pl-4 max-h-[300px] overflow-auto  list-disc  text-sm  font-regular">
                <li>The miles earned in the corresponding month of the previous year will automatically expire at 00:00
                  (UTC) on the 15th of each month.
                </li>
                ...
                <li>In the future, miles may be integrated with external services and points(separate notice will be
                  provided).
                </li>
              </ul>
            </div>
